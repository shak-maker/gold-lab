...
үйлчилнэ.
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-24">
          ...
          >
            ...
            Хамгийн нарийвчлалтай, найдвартай, хүртээмжтэй /алтны/ сорьц тогтоох шинжилгээний үйлчилгээг шударга байдал, үйлчлүүлэгчийн үйлчилгээний хамгийн өндөр стандартыг үзүүлэх. 
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-zinc-600 leading-relaxed">
            Олон улсын түвшинд хүлээн зөвшөөрөгдсөн сорьц тогтоох төв болж, өндөр технологи, шинжлэх ухаан, мэргэжлийн ур чадвардаа тулгуурлан итгэлцлийг бий болгоно.
            </p>
          </motion.div>
        </div>
      </div>
