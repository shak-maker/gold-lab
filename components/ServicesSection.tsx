...
import { Microscope, ScanLine, Gem } from "lucide-react";

const services = [
  {
    icon: Microscope,
    title: "Алтны сорьц тогтоох шинжилгээ",
    description: "Алтны агууламж тодорхойлох олон улсын хүлээн зөвшөөрөгдсөн ISO 11426:2021 стандартын арга, аргачлал, орчин үеийн дэвшилтэт нарийвчлал өндөр тоног төхөөрөмж ашиглан гүйцэтгэх Пробирын арга.",
    features: ["Өндөр нарийвчлал бүхий шинжилгээний үр дүн"],
  },
  {
    icon: Gem,
    title: "Үнэт металл хайлж, гулдмайлах",
    description: "Орчин үеийн технологи, нарийн хяналт бүхий тоног төхөөрөмж, баталгаат хэмжих хэрэгсэл, туршлагатай оператор, баталгаажсан хяналтын дор алт, мөнгийг хайлж гулдмайлах.",
    features: ["Хүлээн зөвшөөрөгдсөн дардс, дугаар", "Хайлалтын акт"],
  },
  {
    icon: ScanLine,
    title: "Мөнгөний сорьц тогтоох шинжилгээ",
    description: "Мөнгөний агууламж тодорхойлох олон улсын хүлээн зөвшөөрөгдсөн ISO 11427:2021 стандартын арга, аргачлал, орчин үеийн дэвшилтэт өндөр нарийвчлал бүхий тоног төхөөрөмж ашиглан гүйцэтгэх Эзлэхүүний арга.",
    features: ["Өндөр нарийвчлал бүхий шинжилгээний үр дүн"],
  },
];
